    ...
    return (
      <div className="homepage">
        <div id="demo">
          ...
          <p>
            Es-Correcto helps you manage all your subscriptions under one
            umbrella.
          </p>
          <p> Start Saving!</p>
          <p>
            {' '}
            We provide you with monthly reports based on your subscription plans
            and related costs.
          </p>
          <p>
            {' '}
            We also send you email remainders informing you when a payment is
            due.
          </p>
          <p>
            If you do not see your product, click on the{' '}
            <strong>"add product"</strong> button and add your custom product
